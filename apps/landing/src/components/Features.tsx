const features = [
  ...
  },
  {
    ...
    title: "Real-Time",
    desc: <><code>HandleSSE</code> gives you typed server push with an <code>sse</code> helper. <code>HandleWS</code> adds typed bidirectional WebSockets with a <code>websocket</code> helper.</>,
  },
];
