...
api.HandleSSE("GET /events", func(r *http.Request, in EventInput, sse *shiftapi.SSEWriter) error {
...
api.HandleSSE("GET /rooms/{room_id}/events", func(r *http.Request, in StreamInput, sse *shiftapi.SSEWriter) error {
...
```go
api.HandleSSE("GET /events", handler,
    shiftapi.SSESends(shiftapi.SSEEventType[Event]("event")),
