...
The generated client includes a `subscribe` function for SSE endpoints registered with `HandleSSE`. Use it directly or with the `useSSE` hook from your API package:
