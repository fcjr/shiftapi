...
- **Server-Sent Events** — `HandleSSE` gives you a typed writer, automatic SSE headers, and a generated `subscribe` helper with React/Svelte hooks
- **WebSockets** — `HandleWS` gives you a typed bidirectional connection with automatic upgrade handling and a generated `connect` helper
