...
Go 1.27 or later. Route registration uses generic methods, which landed in that
release.
...
- **WebSockets** — `HandleWS` gives you typed message handlers with automatic upgrade handling, a generated `websocket` helper, and automatic reconnection
