...
func TestWithEnum_bodyField(t *testing.T) {
	...
	api.Handle("POST /items", func(r *http.Request, in *Req) (*Resp, error) {
...
func TestWithEnum_queryParam(t *testing.T) {
	...
	api.Handle("GET /items", func(r *http.Request, in *Req) (*Resp, error) {
		return &Resp{OK: true}, nil
	})
...
func TestWithEnum_pathParam(t *testing.T) {
	...
	api.Handle("GET /items/{status}", func(r *http.Request, in *Req) (*Resp, error) {
		return &Resp{OK: true}, nil
	})
...
func TestWithEnum_intEnum(t *testing.T) {
	...
	api.Handle("POST /tasks", func(r *http.Request, in *Req) (*Resp, error) {
		return &Resp{OK: true}, nil
	})
