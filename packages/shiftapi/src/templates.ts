...
${indent(generatedTypes)}
  ...
  export function subscribe<P extends SSEPaths>(
    path: P,
...
import { createSubscribe, createWebSocket } from "shiftapi/internal";
...
export const subscribe = createSubscribe(${JSON.stringify(baseUrl)});
...
export const subscribe = createSubscribe(baseUrl);
